...
public class HelloWorld_Lubm {
	...
	public static void main(String[] args) {
		...
		String query = 
				...
				+ "#from stream <http://lubm.org#universities2> [TIME 2s STEP 1s];"
				...
				+ "steveProfessor(X,Y) :- rdf_type(X, \"uniben_Professor\"), uniben_name(X,Y), (@getStringValue(Y)) = \"Steve\";"
				+ "#show uniben_famousProfessor/2;"
				+ "#show steveProfessor/2;";
//				+ "#show steveProfessor/1";
